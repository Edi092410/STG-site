                ...
                <Box>
                    <div className='w-full flex flex-col justify-center px-[20%]'>
                        <div className='flex justify-center my-[20px]'>
                            <img src={image} alt="help page main picture" width={"70px"} height={"70px"}/>
                        </div>
                        <div className=' text-center text-[#032D60] font-medium'>24/7 Онлайн үйлчилгээний хүсэлт илгээх боломжтой</div>
